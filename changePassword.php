		...
		<div id="container">
			...
			<table id="tblPost">
				<tr>
					...
					<td height="40"><input type="password" name="currentPass" /></td>
				</tr>
				<tr>
					<td height="40">New Password:</td>
					<td height="40"><input type="password" name="newPass" /></td>
				</tr>
				<tr>
					<td height="40" colspan="2" style="text-align: center;"><input type="submit" name="savePassword" value="Save" /></td>
				</tr>
