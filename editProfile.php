		...
		<div id="container">
			...
			<table id="tblPost">
				<tr>
					...
					<td height="40"><input type="text" name="email" /></td>
				</tr>
				<tr>
					<td height="40">Phone Number:</td>
					<td height="40"><input type="text" name="pNumber" /></td>
				</tr>
				<tr>
					<td height="40">Birthday:</td>
					<td height="40"><input type="text" name="bday" /></td>
				</tr>
				<tr>
					<td height="40">Gender:</td>
					<td height="40"><input type="radio" name="sex" value="female" />Female&nbsp; &nbsp;<input type="radio" name="sex" value="male" />Male</td>
				</tr>
				<tr>
					<td height="40">Change profile picture:</td>
					<td height="40"><input type="file" name="chngPhoto" accept="image/*" /></td>
				</tr>
				<tr>
					<td height="40" colspan="2" style="text-align: center;"><input type="submit" name="saveProfilechng" value="Save" /></td>
				</tr>
